...
// Clase de apoyo para manejar la cantidad personalizada de cada ingrediente en la UI
data class IngredienteReceta(
    val alimento: Alimento,
    var cantidadPersonalizada: String
)

object NuevaRecetaScreen : Screen {
    ...
    override fun Content() {
        ...
        var aguaAgregada by remember { mutableStateOf("") }

        // Ahora nuestra lista guarda el alimento Y la cantidad que el usuario quiere
        ...
        Scaffold(
            ...
            topBar = {
                CenterAlignedTopAppBar(
                    title = { Text("Nueva Receta", color = BlancoPuro, fontWeight = FontWeight.Bold) },
                    navigationIcon = {
            ...
            floatingActionButton = {
                FloatingActionButton(
                    onClick = {
                        ...
                        // Preparamos los mapas para Firebase
                        ...
                        val nuevaReceta = hashMapOf(
                            ...
                            "CantidadesReceta" to mapaCantidades // NUEVO: Guardamos cuánto pesa cada cosa
                        )

                        db.collection("Recetas").document(idUnico).set(nuevaReceta)
                    ...
                    Icon(Icons.Default.AddCircle, contentDescription = "Guardar Receta")
                }
            }
        ) { paddingValues ->
            Column(
                ...
                Row(
                    ...
                    MacroPieChartReceta(totalCarbos, totalProteinas, totalGrasas, totalKcal)
                }
                ...
                Row(
                    ...
                    MacroMiniTextReceta("Carbos", totalCarbos.toInt().toString() + "g", RosaCarbos)
                    MacroMiniTextReceta("Prote", totalProteinas.toInt().toString() + "g", AzulProte)
                    MacroMiniTextReceta("Grasas", totalGrasas.toInt().toString() + "g", AmarilloGrasas)
                }
                        ...
                        ingredientesSeleccionados.forEachIndexed { index, item ->
                            ...
                            Row(
                                ...
                                Column(modifier = Modifier.weight(1f)) {
                                    ...
                                    // Macros calculados en vivo para esta cantidad
                            ...
                            items(misAlimentosDB) { alimento ->
                                Row(
                                    modifier = Modifier
                                        .fillMaxWidth()
                                        .clickable {
                                            // Por defecto al añadirlo ponemos su cantidad base (ej: 100)
    ...
    @Composable
    fun MacroPieChartReceta(carbs: Double, proteins: Double, fats: Double, kcal: Double) {
